...
print
    ...
    ."\x36\x00\x00\x00"     # Offset of the 1st pixel array
    ."\x28\x00\x00\x00"     # Size of DIB header
    .pack("i", $ARGV[1])    # Width of the bitmap
    .pack("i", $ARGV[2])    # Height of the bitmap
    ...
    ."\x80\x04\x00\x00"     # Horizontal resolution
    ."\x60\x03\x00\x00"     # Vertical resolution
